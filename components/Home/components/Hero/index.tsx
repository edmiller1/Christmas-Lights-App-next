    ...
    <div className="relative min-h-screen px-6 isolate pt-14 lg:px-8">
      ...
      <div className="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-green-400">
          ...
          <div className="flex items-center justify-center mt-10 gap-x-6">
            <Input
              ...
              placeholder="Search by city, country or decoration"
            />
          </div>
        </div>
      </div>
